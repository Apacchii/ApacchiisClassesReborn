...
namespace ApacchiisClassesMod2.UI
{
    class CrusaderTalents : UIState
    {
        ...
        string className = "Crusader";

        float L1Scale = 1f;
        float R1Scale = 1f;
        string L1 = "+2% Cooldown Reduction";
        string R1 = "-3% Ultimate Cost";

        float L2Scale = 1f;
        float R2Scale = 1f;
        string L2 = "[+] +1% Passive Endurance"; //Only applies to non-buff dr
        string R2 = "+18 Hammer Base Damage";

        float L3Scale = 1f;
        float R3Scale = 1f;
        string L3 = "+30% Hammer Range";
        string R3 = "+2% Max Health";

        float L4Scale = 1f;
        float R4Scale = 1f;
        string L4 = "+2% Melee Damage";
        string R4 = "-3% Ultimate Cost";

        float L5Scale = 1f;
        float R5Scale = .95f;
        string L5 = "[+] +1% Passive Endurance";
        string R5 = "+1s Guardian Angel Duration";

        float L6Scale = 1f;
        float R6Scale = .9f;
        string L6 = "+35% Hammer Range";
        string R6 = "+5% Guardian Angel Reduction";

        float L7Scale = 1f;
        float R7Scale = 1f;
        string L7 = "+2% Melee Crit";
        string R7 = "3% Healing Power";

        float L8Scale = 1f;
        float R8Scale = .9f;
        string L8 = "+45 Hammer Base Damage";
        string R8 = "[+] Regenerate Health p/Second"; //0.1% p/sec

        float L9Scale = 1;
        float R9Scale = 1f;
        string L9 = "-4% Ultimate Cost";
        string R9 = "[+] Hammer Upgrades"; //+ Range & +dmg

        float L10Scale = .95f;
        float R10Scale = .95f;
        string L10 = "+2.5% Protection Base Healing";
        string R10 = "+3s Guardian Angel Duration";
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (button8_Right.IsMouseHovering)
            {
                ...
                textInfoLeft.SetText($"[Tenacity]\nHealing is 0.1% of your max health\nper second.\n\nHealth gained cannot be lower\nthan 1.");
            }
            else
            if (button9_Right.IsMouseHovering)
            {
                Append(infoLeft);
                infoLeft.Append(textInfoLeft);
                textInfoLeft.SetText($"[Hallowed Hammer]\n+15% Hammer range.\n+24 Hammer base damage.");
            }
            else
            if (button5_Left.IsMouseHovering)
            {
                Append(infoLeft);
                infoLeft.Append(textInfoLeft);
                textInfoLeft.SetText($"[Tenacity]\nOnly applies to the non-buff\ndamage reduction that is always\nactive.");
            }
            else
            ...
            classText.SetText(className + ": " + acmPlayer.crusaderSkillPoints + " Skill Points");
            ...
            if (acmPlayer.crusaderSpentSkillPoints < 1 && acmPlayer.crusaderTalent_2 == "N")
            {
                button2_Left.BackgroundColor = new Color(50, 50, 50);
                button2_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.crusaderTalent_2 == "N")
            {
                button2_Left.BackgroundColor = new Color(75, 75, 75);
                button2_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.crusaderSpentSkillPoints < 2 && acmPlayer.crusaderTalent_3 == "N")
            {
                button3_Left.BackgroundColor = new Color(50, 50, 50);
                button3_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.crusaderTalent_3 == "N")
            {
                button3_Left.BackgroundColor = new Color(75, 75, 75);
                button3_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.crusaderSpentSkillPoints < 3 && acmPlayer.crusaderTalent_4 == "N")
            {
                button4_Left.BackgroundColor = new Color(50, 50, 50);
                button4_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.crusaderTalent_4 == "N")
            {
                button4_Left.BackgroundColor = new Color(75, 75, 75);
                button4_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.crusaderSpentSkillPoints < 4 && acmPlayer.crusaderTalent_5 == "N")
            {
                button5_Left.BackgroundColor = new Color(50, 50, 50);
                button5_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.crusaderTalent_5 == "N")
            {
                button5_Left.BackgroundColor = new Color(75, 75, 75);
                button5_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.crusaderSpentSkillPoints < 5 && acmPlayer.crusaderTalent_6 == "N")
            {
                button6_Left.BackgroundColor = new Color(50, 50, 50);
                button6_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.crusaderTalent_6 == "N")
            {
                button6_Left.BackgroundColor = new Color(75, 75, 75);
                button6_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.crusaderSpentSkillPoints < 6 && acmPlayer.crusaderTalent_7  == "N")
            {
                button7_Left.BackgroundColor = new Color(50, 50, 50);
                button7_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.crusaderTalent_7 == "N")
            {
                button7_Left.BackgroundColor = new Color(75, 75, 75);
                button7_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.crusaderSpentSkillPoints < 7 && acmPlayer.crusaderTalent_8 == "N")
            {
                button8_Left.BackgroundColor = new Color(50, 50, 50);
                button8_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.crusaderTalent_8 == "N")
            {
                button8_Left.BackgroundColor = new Color(75, 75, 75);
                button8_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.crusaderSpentSkillPoints < 8 && acmPlayer.crusaderTalent_9 == "N")
            {
                button9_Left.BackgroundColor = new Color(50, 50, 50);
                button9_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.crusaderTalent_9 == "N")
            {
                button9_Left.BackgroundColor = new Color(75, 75, 75);
                button9_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.crusaderSpentSkillPoints < 9 && acmPlayer.crusaderTalent_10 == "N")
            {
                button10_Left.BackgroundColor = new Color(50, 50, 50);
                button10_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.crusaderTalent_10 == "N")
            {
                button10_Left.BackgroundColor = new Color(75, 75, 75);
                button10_Right.BackgroundColor = new Color(75, 75, 75);
            }
            ...
            if(acmPlayer.crusaderTalent_10 != "N")
            {
                ...
                leftSinkText.SetText($"+{(acmPlayer.talentSinkCrusaderLeftValue * 100).ToString("F2")}% Ability Power ({(acmPlayer.talentSinkCrusaderLeftValue * acmPlayer.talentSinkCrusaderLeft * 100).ToString("F2")}%)");
                rightSinkText.SetText($"+{(acmPlayer.talentSinkCrusaderRightValue * 100).ToString("F2")}% Heal Power ({(acmPlayer.talentSinkCrusaderRightValue * acmPlayer.talentSinkCrusaderRight * 100).ToString("F2")}%)");
            } 
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if(acmPlayer.crusaderTalent_1 == "N" && acmPlayer.crusaderSkillPoints > 0)
            {
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                acmPlayer.crusaderTalent_1 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.crusaderTalent_2 == "N" && acmPlayer.crusaderSkillPoints > 0 && acmPlayer.crusaderSpentSkillPoints >= 1)
            {
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                acmPlayer.crusaderTalent_2 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.crusaderTalent_3 == "N" && acmPlayer.crusaderSkillPoints > 0 && acmPlayer.crusaderSpentSkillPoints >= 2)
            {
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                acmPlayer.crusaderTalent_3 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.crusaderTalent_4 == "N" && acmPlayer.crusaderSkillPoints > 0 && acmPlayer.crusaderSpentSkillPoints >= 3)
            {
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                acmPlayer.crusaderTalent_4 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.crusaderTalent_5 == "N" && acmPlayer.crusaderSkillPoints > 0 && acmPlayer.crusaderSpentSkillPoints >= 4)
            {
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                acmPlayer.crusaderTalent_5 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.crusaderTalent_6 == "N" && acmPlayer.crusaderSkillPoints > 0 && acmPlayer.crusaderSpentSkillPoints >= 5)
            {
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                acmPlayer.crusaderTalent_6 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.crusaderTalent_7 == "N" && acmPlayer.crusaderSkillPoints > 0 && acmPlayer.crusaderSpentSkillPoints >= 6)
            {
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                acmPlayer.crusaderTalent_7 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.crusaderTalent_8 == "N" && acmPlayer.crusaderSkillPoints > 0 && acmPlayer.crusaderSpentSkillPoints >= 7)
            {
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                acmPlayer.crusaderTalent_8 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.crusaderTalent_9 == "N" && acmPlayer.crusaderSkillPoints > 0 && acmPlayer.crusaderSpentSkillPoints >= 8)
            {
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                acmPlayer.crusaderTalent_9 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.crusaderTalent_10 == "N" && acmPlayer.crusaderSkillPoints > 0 && acmPlayer.crusaderSpentSkillPoints >= 9)
            {
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                acmPlayer.crusaderTalent_10 = "L";
            }
        ...
        private void LeftSink_LClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.crusaderSkillPoints > 0)
            {
                acmPlayer.talentSinkCrusaderLeft++;
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
        ...
        private void LeftSink_RClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if(acmPlayer.talentSinkCrusaderLeft > 0)
            {
                acmPlayer.talentSinkCrusaderLeft--;
                acmPlayer.crusaderSkillPoints++;
                acmPlayer.crusaderSpentSkillPoints--;
        ...
        private void RightSink_LClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if(acmPlayer.crusaderSkillPoints > 0)
            {
                acmPlayer.talentSinkCrusaderRight++;
                acmPlayer.crusaderSkillPoints--;
                acmPlayer.crusaderSpentSkillPoints++;
                SoundEngine.PlaySound(SoundID.MenuOpen);
            }
        ...
        private void RightSink_RClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.talentSinkCrusaderRight > 0)
            {
                acmPlayer.talentSinkCrusaderRight--;
                acmPlayer.crusaderSkillPoints++;
                acmPlayer.crusaderSpentSkillPoints--;
        ...
        {
            GetInstance<ACM2ModSystem>()._CrusaderTalents.SetState(null);
            SoundEngine.PlaySound(SoundID.MenuClose);
        }
    }
}