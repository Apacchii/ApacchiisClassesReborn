...
namespace ApacchiisClassesMod2.UI
{
    class GamblerTalents : UIState
    {
        ...
        float L1Scale = 1f;
        float R1Scale = 1f;
        string L1 = "[+] +2.5% Passive Min/Max";
        string R1 = "+8 Dice Base Damage";

        float L2Scale = 1f;
        float R2Scale = 1f;
        string L2 = "+2% Dodge Chance";
        string R2 = "-8% Ultimate Cost";

        float L3Scale = 1f;
        float R3Scale = 1f;
        string L3 = "+1s Lucky Streak Duration";
        string R3 = "+16% Ability Power";

        float L4Scale = .9f;
        float R4Scale = 1f;
        string L4 = "[+] +8% Lucky Streak Min/Max";
        string R4 = "+2% Ranged Crit";

        float L5Scale = 1f;
        float R5Scale = 1f;
        string L5 = "Throw 5 Dice Instead Of 3";
        string R5 = "+3% Dodge Chance";

        float L6Scale = 1f;
        float R6Scale = 1f;
        string L6 = "[+] +2.5% Passive Min/Max";
        string R6 = "+10% Cooldown Reduction";

        float L7Scale = .8f;
        float R7Scale = 1f;
        string L7 = "Lucky Streak Now Grants 5% Dodge";
        string R7 = "[+] +5% Passive Min/Max";

        float L8Scale = 1f;
        float R8Scale = 1f;
        string L8 = "+23 Dice Base Damage";
        string R8 = "+4% Dodge Chance";

        float L9Scale = 1f;
        float R9Scale = .9f;
        string L9 = "+2s Ult Duration";
        string R9 = "[+] +10% Lucky Streak Min/Max";

        float L10Scale = 1f;
        float R10Scale = 1f;
        string L10 = "+3s Lucky Streak Duration";
        string R10 = "+15% Ult Attack Speed";
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (button1_Left.IsMouseHovering)
            {
                ...
                textInfoLeft.SetText($"[Luck Of The Draw]\nBoth the passive's minimum\ndamage and maximum damage are\nincreased.");
            }
            ...
            if (button4_Left.IsMouseHovering)
            {
                Append(infoLeft);
                infoLeft.Append(textInfoLeft);
                textInfoLeft.SetText($"[Lucky Streak]\nBoth the ability's minimum\ndamage and maximum damage are\nincreased.");
            }
            ...
            classText.SetText(className + ": " + acmPlayer.gamblerSkillPoints + " Skill Points");
            ...
            if (acmPlayer.gamblerSpentSkillPoints < 1 && acmPlayer.gamblerTalent_2 == "N")
            {
                button2_Left.BackgroundColor = new Color(50, 50, 50);
                button2_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.gamblerTalent_2 == "N")
            {
                button2_Left.BackgroundColor = new Color(75, 75, 75);
                button2_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.gamblerSpentSkillPoints < 2 && acmPlayer.gamblerTalent_3 == "N")
            {
                button3_Left.BackgroundColor = new Color(50, 50, 50);
                button3_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.gamblerTalent_3 == "N")
            {
                button3_Left.BackgroundColor = new Color(75, 75, 75);
                button3_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.gamblerSpentSkillPoints < 3 && acmPlayer.gamblerTalent_4 == "N")
            {
                button4_Left.BackgroundColor = new Color(50, 50, 50);
                button4_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.gamblerTalent_4 == "N")
            {
                button4_Left.BackgroundColor = new Color(75, 75, 75);
                button4_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.gamblerSpentSkillPoints < 4 && acmPlayer.gamblerTalent_5 == "N")
            {
                button5_Left.BackgroundColor = new Color(50, 50, 50);
                button5_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.gamblerTalent_5 == "N")
            {
                button5_Left.BackgroundColor = new Color(75, 75, 75);
                button5_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.gamblerSpentSkillPoints < 5 && acmPlayer.gamblerTalent_6 == "N")
            {
                button6_Left.BackgroundColor = new Color(50, 50, 50);
                button6_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.gamblerTalent_6 == "N")
            {
                button6_Left.BackgroundColor = new Color(75, 75, 75);
                button6_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.gamblerSpentSkillPoints < 6 && acmPlayer.gamblerTalent_7  == "N")
            {
                button7_Left.BackgroundColor = new Color(50, 50, 50);
                button7_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.gamblerTalent_7 == "N")
            {
                button7_Left.BackgroundColor = new Color(75, 75, 75);
                button7_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.gamblerSpentSkillPoints < 7 && acmPlayer.gamblerTalent_8 == "N")
            {
                button8_Left.BackgroundColor = new Color(50, 50, 50);
                button8_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.gamblerTalent_8 == "N")
            {
                button8_Left.BackgroundColor = new Color(75, 75, 75);
                button8_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.gamblerSpentSkillPoints < 8 && acmPlayer.gamblerTalent_9 == "N")
            {
                button9_Left.BackgroundColor = new Color(50, 50, 50);
                button9_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.gamblerTalent_9 == "N")
            {
                button9_Left.BackgroundColor = new Color(75, 75, 75);
                button9_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.gamblerSpentSkillPoints < 9 && acmPlayer.gamblerTalent_10 == "N")
            {
                button10_Left.BackgroundColor = new Color(50, 50, 50);
                button10_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.gamblerTalent_10 == "N")
            {
                button10_Left.BackgroundColor = new Color(75, 75, 75);
                button10_Right.BackgroundColor = new Color(75, 75, 75);
            }
            ...
            if (acmPlayer.gamblerTalent_10 != "N")
            {
                ...
                leftSinkText.SetText($"+{(acmPlayer.talentSinkGamblerLeftValue * 100).ToString("F2")}% Cooldown Reduction ({(acmPlayer.talentSinkGamblerLeftValue * acmPlayer.talentSinkGamblerLeft * 100).ToString("F2")}%)");
                rightSinkText.SetText($"+{(acmPlayer.talentSinkGamblerRightValue * 100).ToString("F2")}% Ranged Damage ({(acmPlayer.talentSinkGamblerRightValue * acmPlayer.talentSinkGamblerRight * 100).ToString("F2")}%)");
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if(acmPlayer.gamblerTalent_1 == "N" && acmPlayer.gamblerSkillPoints > 0)
            {
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                acmPlayer.gamblerTalent_1 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.gamblerTalent_2 == "N" && acmPlayer.gamblerSkillPoints > 0 && acmPlayer.gamblerSpentSkillPoints >= 1)
            {
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                acmPlayer.gamblerTalent_2 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.gamblerTalent_3 == "N" && acmPlayer.gamblerSkillPoints > 0 && acmPlayer.gamblerSpentSkillPoints >= 2)
            {
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                acmPlayer.gamblerTalent_3 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.gamblerTalent_4 == "N" && acmPlayer.gamblerSkillPoints > 0 && acmPlayer.gamblerSpentSkillPoints >= 3)
            {
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                acmPlayer.gamblerTalent_4 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.gamblerTalent_5 == "N" && acmPlayer.gamblerSkillPoints > 0 && acmPlayer.gamblerSpentSkillPoints >= 4)
            {
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                acmPlayer.gamblerTalent_5 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.gamblerTalent_6 == "N" && acmPlayer.gamblerSkillPoints > 0 && acmPlayer.gamblerSpentSkillPoints >= 5)
            {
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                acmPlayer.gamblerTalent_6 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.gamblerTalent_7 == "N" && acmPlayer.gamblerSkillPoints > 0 && acmPlayer.gamblerSpentSkillPoints >= 6)
            {
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                acmPlayer.gamblerTalent_7 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.gamblerTalent_8 == "N" && acmPlayer.gamblerSkillPoints > 0 && acmPlayer.gamblerSpentSkillPoints >= 7)
            {
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                acmPlayer.gamblerTalent_8 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.gamblerTalent_9 == "N" && acmPlayer.gamblerSkillPoints > 0 && acmPlayer.gamblerSpentSkillPoints >= 8)
            {
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                acmPlayer.gamblerTalent_9 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.gamblerTalent_10 == "N" && acmPlayer.gamblerSkillPoints > 0 && acmPlayer.gamblerSpentSkillPoints >= 9)
            {
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                acmPlayer.gamblerTalent_10 = "L";
            }
        ...
        private void LeftSink_LClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.gamblerSkillPoints > 0)
            {
                acmPlayer.talentSinkGamblerLeft++;
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
        ...
        private void LeftSink_RClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.talentSinkGamblerLeft > 0)
            {
                acmPlayer.talentSinkGamblerLeft--;
                acmPlayer.gamblerSkillPoints++;
                acmPlayer.gamblerSpentSkillPoints--;
        ...
        private void RightSink_LClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.gamblerSkillPoints > 0)
            {
                acmPlayer.talentSinkGamblerRight++;
                acmPlayer.gamblerSkillPoints--;
                acmPlayer.gamblerSpentSkillPoints++;
                SoundEngine.PlaySound(SoundID.MenuOpen);
            }
        ...
        private void RightSink_RClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.talentSinkGamblerRight > 0)
            {
                acmPlayer.talentSinkGamblerRight--;
                acmPlayer.gamblerSkillPoints++;
                acmPlayer.gamblerSpentSkillPoints--;
        ...
        {
            GetInstance<ACM2ModSystem>()._GamblerTalents.SetState(null);
            SoundEngine.PlaySound(SoundID.MenuClose);
        }
    }
}