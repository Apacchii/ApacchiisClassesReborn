...
{
    class SoulmancerTalents : UIState
    {
        ...
        string className = "Soulmancer";

        float L1Scale = 1f;
        float R1Scale = 1f;
        string L1 = "+1% Soul Rip Chance";
        string R1 = "+10% Ability Power";

        float L2Scale = 1f;
        float R2Scale = 1f;
        string L2 = "+6% Cooldown Reduction";
        string R2 = "+2% Magic Crit";

        float L3Scale = 1f;
        float R3Scale = 1f;
        string L3 = "-6% Ult Cost";
        string R3 = "+2% Soul Rip Chance";

        float L4Scale = 1f;
        float R4Scale = 1f;
        string L4 = "+11 Soul Rip Damage";
        string R4 = "+65 Soul Shatter Range";

        float L5Scale = 1f;
        float R5Scale = 1f;
        string L5 = "-4% Ult Cost";
        string R5 = "+24 Soul Shatter Damage";

        float L6Scale = 1f;
        float R6Scale = 1f;
        string L6 = "+1s Consume Duration";
        string R6 = "+12 Soul Rip Damage";

        float L7Scale = 1f;
        float R7Scale = 1f;
        string L7 = "+2% Soul Rip Chance";
        string R7 = "+2% Magic Crit";

        float L8Scale = 1f;
        float R8Scale = 1f;
        string L8 = "+95 Soul Shatter Range";
        string R8 = "+3% Soul Rip Chance";

        float L9Scale = 1f;
        float R9Scale = 1f;
        string L9 = "+16% Ability Power";
        string R9 = "+8% Cooldown Reduction";

        float L10Scale = 1f;
        float R10Scale = 1f;
        string L10 = "+4% Soul Rip Chance";
        string R10 = "+1s Consume Duration";
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            classText.SetText(className + ": " + acmPlayer.soulmancerSkillPoints + " Skill Points");
            ...
            if (acmPlayer.soulmancerSpentSkillPoints < 1 && acmPlayer.soulmancerTalent_2 == "N")
            {
                button2_Left.BackgroundColor = new Color(50, 50, 50);
                button2_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.soulmancerTalent_2 == "N")
            {
                button2_Left.BackgroundColor = new Color(75, 75, 75);
                button2_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.soulmancerSpentSkillPoints < 2 && acmPlayer.soulmancerTalent_3 == "N")
            {
                button3_Left.BackgroundColor = new Color(50, 50, 50);
                button3_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.soulmancerTalent_3 == "N")
            {
                button3_Left.BackgroundColor = new Color(75, 75, 75);
                button3_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.soulmancerSpentSkillPoints < 3 && acmPlayer.soulmancerTalent_4 == "N")
            {
                button4_Left.BackgroundColor = new Color(50, 50, 50);
                button4_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.soulmancerTalent_4 == "N")
            {
                button4_Left.BackgroundColor = new Color(75, 75, 75);
                button4_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.soulmancerSpentSkillPoints < 4 && acmPlayer.soulmancerTalent_5 == "N")
            {
                button5_Left.BackgroundColor = new Color(50, 50, 50);
                button5_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.soulmancerTalent_5 == "N")
            {
                button5_Left.BackgroundColor = new Color(75, 75, 75);
                button5_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.soulmancerSpentSkillPoints < 5 && acmPlayer.soulmancerTalent_6 == "N")
            {
                button6_Left.BackgroundColor = new Color(50, 50, 50);
                button6_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.soulmancerTalent_6 == "N")
            {
                button6_Left.BackgroundColor = new Color(75, 75, 75);
                button6_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.soulmancerSpentSkillPoints < 6 && acmPlayer.soulmancerTalent_7  == "N")
            {
                button7_Left.BackgroundColor = new Color(50, 50, 50);
                button7_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.soulmancerTalent_7 == "N")
            {
                button7_Left.BackgroundColor = new Color(75, 75, 75);
                button7_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.soulmancerSpentSkillPoints < 7 && acmPlayer.soulmancerTalent_8 == "N")
            {
                button8_Left.BackgroundColor = new Color(50, 50, 50);
                button8_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.soulmancerTalent_8 == "N")
            {
                button8_Left.BackgroundColor = new Color(75, 75, 75);
                button8_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.soulmancerSpentSkillPoints < 8 && acmPlayer.soulmancerTalent_9 == "N")
            {
                button9_Left.BackgroundColor = new Color(50, 50, 50);
                button9_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.soulmancerTalent_9 == "N")
            {
                button9_Left.BackgroundColor = new Color(75, 75, 75);
                button9_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.soulmancerSpentSkillPoints < 9 && acmPlayer.soulmancerTalent_10 == "N")
            {
                button10_Left.BackgroundColor = new Color(50, 50, 50);
                button10_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.soulmancerTalent_10 == "N")
            {
                button10_Left.BackgroundColor = new Color(75, 75, 75);
                button10_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.soulmancerTalent_1 == "L")
            {
            ...
            if (acmPlayer.soulmancerTalent_10 != "N")
            {
                ...
                leftSinkText.SetText($"+{(acmPlayer.talentSinkSoulmancerLeftValue * 100).ToString("F2")}% Ability Power ({(acmPlayer.talentSinkSoulmancerLeftValue * acmPlayer.talentSinkSoulmancerLeft * 100).ToString("F2")}%)");
                rightSinkText.SetText($"+{(acmPlayer.talentSinkSoulmancerRightValue * 100).ToString("F2")}% Magic Damage ({(acmPlayer.talentSinkSoulmancerRightValue * acmPlayer.talentSinkSoulmancerRight * 100).ToString("F2")}%)");
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if(acmPlayer.soulmancerTalent_1 == "N" && acmPlayer.soulmancerSkillPoints > 0)
            {
        ...
        private void Button1R(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerTalent_1 == "N" && acmPlayer.soulmancerSkillPoints > 0)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_1 = "R";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.soulmancerTalent_2 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 1)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_2 = "L";
            }
        ...
        private void Button2R(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerTalent_2 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 1)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_2 = "R";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.soulmancerTalent_3 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 2)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_3 = "L";
            }
        ...
        private void Button3R(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerTalent_3 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 2)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_3 = "R";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.soulmancerTalent_4 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 3)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_4 = "L";
            }
        ...
        private void Button4R(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerTalent_4 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 3)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_4 = "R";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.soulmancerTalent_5 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 4)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_5 = "L";
            }
        ...
        private void Button5R(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerTalent_5 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 4)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_5 = "R";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.soulmancerTalent_6 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 5)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_6 = "L";
            }
        ...
        private void Button6R(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerTalent_6 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 5)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_6 = "R";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.soulmancerTalent_7 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 6)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_7 = "L";
            }
        ...
        private void Button7R(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerTalent_7 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 6)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_7 = "R";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.soulmancerTalent_8 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 7)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_8 = "L";
            }
        ...
        private void Button8R(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerTalent_8 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 7)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_8 = "R";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.soulmancerTalent_9 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 8)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_9 = "L";
            }
        ...
        private void Button9R(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerTalent_9 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 8)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_9 = "R";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.soulmancerTalent_10 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 9)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_10 = "L";
            }
        ...
        private void Button10R(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerTalent_10 == "N" && acmPlayer.soulmancerSkillPoints > 0 && acmPlayer.soulmancerSpentSkillPoints >= 9)
            {
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                acmPlayer.soulmancerTalent_10 = "R";
            }
        ...
        private void LeftSink_LClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerSkillPoints > 0)
            {
                acmPlayer.talentSinkSoulmancerLeft++;
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
        ...
        private void LeftSink_RClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.talentSinkSoulmancerLeft > 0)
            {
                acmPlayer.talentSinkSoulmancerLeft--;
                acmPlayer.soulmancerSkillPoints++;
                acmPlayer.soulmancerSpentSkillPoints--;
        ...
        private void RightSink_LClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.soulmancerSkillPoints > 0)
            {
                acmPlayer.talentSinkSoulmancerRight++;
                acmPlayer.soulmancerSkillPoints--;
                acmPlayer.soulmancerSpentSkillPoints++;
                SoundEngine.PlaySound(SoundID.MenuOpen);
            }
        ...
        private void RightSink_RClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.talentSinkSoulmancerRight > 0)
            {
                acmPlayer.talentSinkSoulmancerRight--;
                acmPlayer.soulmancerSkillPoints++;
                acmPlayer.soulmancerSpentSkillPoints--;
        ...
        {
            GetInstance<ACM2ModSystem>()._SoulmancerTalents.SetState(null);
            SoundEngine.PlaySound(SoundID.MenuClose);
        }
    }
}