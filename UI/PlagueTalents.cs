...
namespace ApacchiisClassesMod2.UI
{
    class PlagueTalents : UIState
    {
        ...
        string className = "Plague";

        float L1Scale = 1f;
        float R1Scale = .85f;
        string L1 = "+4% Ability Power";
        string R1 = "[+] +2% Minion Plagued Damage";

        float L2Scale = .8f;
        float R2Scale = 1f;
        string L2 = "+10 Infect Base Contact Damage";
        string R2 = "+50 Outburst Range";

        float L3Scale = 1f;
        float R3Scale = 1f;
        string L3 = "+1% Minion Crit Chance";
        string R3 = "+7% Cooldown Reduction";

        float L4Scale = 1f;
        float R4Scale = 1f;
        string L4 = "+50 Deadzone Range";
        string R4 = "+30 Outburst Base Damage";

        float L5Scale = 1f;
        float R5Scale = 1f;
        string L5 = "+5% Cooldown Reduction";
        string R5 = "+2% Minion Damage";

        float L6Scale = 1f;
        float R6Scale = 1f;
        string L6 = "+1% Minion Crit Chance";
        string R6 = "+50 Outburst Range";

        float L7Scale = 1f;
        float R7Scale = .85f;
        string L7 = "+50 Deadzone Range";
        string R7 = "[+] +2% Minion Plagued Damage";

        float L8Scale = 1f;
        float R8Scale = 1f;
        string L8 = "+1% Minion Crit Chance";
        string R8 = "+7.5% Max Health";

        float L9Scale = 1;
        float R9Scale = 1f;
        string L9 = "+15% Ability Power";
        string R9 = "+2s Plagued Duration";

        float L10Scale = 1f;
        float R10Scale = 1f;
        string L10 = "[+] Deadzone Ticks Faster";
        string R10 = "[+] Outburst Heals";
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (button1_Right.IsMouseHovering)
            {
                ...
                textInfoLeft.SetText($"[Lethality]\nIncreases the bonus damage your minions deal to enemies affected by Plagued.");
            }
            ...
            if (button10_Left.IsMouseHovering)
            {
                Append(infoLeft);
                infoLeft.Append(textInfoLeft);
                textInfoLeft.SetText($"[Deadzone]\nThe amount of frames that have to pass for the ultimate to deal damage is decreased from 15 to 10.");
            }
            if (button10_Right.IsMouseHovering)
            {
                Append(infoLeft);
                infoLeft.Append(textInfoLeft);
                textInfoLeft.SetText($"[Infection Outburst]\nHealing is 0.5% of your max health per enemy hit that is affected by Plagued.\n\nHealing cannot be lower than 1.");
            }

            

            classText.SetText(className + ": " + acmPlayer.plagueSkillPoints + " Skill Points");
            ...
            if (acmPlayer.plagueSpentSkillPoints < 1 && acmPlayer.plagueTalent_2 == "N")
            {
                button2_Left.BackgroundColor = new Color(50, 50, 50);
                button2_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.plagueTalent_2 == "N")
            {
                button2_Left.BackgroundColor = new Color(75, 75, 75);
                button2_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.plagueSpentSkillPoints < 2 && acmPlayer.plagueTalent_3 == "N")
            {
                button3_Left.BackgroundColor = new Color(50, 50, 50);
                button3_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.plagueTalent_3 == "N")
            {
                button3_Left.BackgroundColor = new Color(75, 75, 75);
                button3_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.plagueSpentSkillPoints < 3 && acmPlayer.plagueTalent_4 == "N")
            {
                button4_Left.BackgroundColor = new Color(50, 50, 50);
                button4_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.plagueTalent_4 == "N")
            {
                button4_Left.BackgroundColor = new Color(75, 75, 75);
                button4_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.plagueSpentSkillPoints < 4 && acmPlayer.plagueTalent_5 == "N")
            {
                button5_Left.BackgroundColor = new Color(50, 50, 50);
                button5_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if(acmPlayer.plagueTalent_5 == "N")
            {
                button5_Left.BackgroundColor = new Color(75, 75, 75);
                button5_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.plagueSpentSkillPoints < 5 && acmPlayer.plagueTalent_6 == "N")
            {
                button6_Left.BackgroundColor = new Color(50, 50, 50);
                button6_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.plagueTalent_6 == "N")
            {
                button6_Left.BackgroundColor = new Color(75, 75, 75);
                button6_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.plagueSpentSkillPoints < 6 && acmPlayer.plagueTalent_7  == "N")
            {
                button7_Left.BackgroundColor = new Color(50, 50, 50);
                button7_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.plagueTalent_7 == "N")
            {
                button7_Left.BackgroundColor = new Color(75, 75, 75);
                button7_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.plagueSpentSkillPoints < 7 && acmPlayer.plagueTalent_8 == "N")
            {
                button8_Left.BackgroundColor = new Color(50, 50, 50);
                button8_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.plagueTalent_8 == "N")
            {
                button8_Left.BackgroundColor = new Color(75, 75, 75);
                button8_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.plagueSpentSkillPoints < 8 && acmPlayer.plagueTalent_9 == "N")
            {
                button9_Left.BackgroundColor = new Color(50, 50, 50);
                button9_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.plagueTalent_9 == "N")
            {
                button9_Left.BackgroundColor = new Color(75, 75, 75);
                button9_Right.BackgroundColor = new Color(75, 75, 75);
            }

            if (acmPlayer.plagueSpentSkillPoints < 9 && acmPlayer.plagueTalent_10 == "N")
            {
                button10_Left.BackgroundColor = new Color(50, 50, 50);
                button10_Right.BackgroundColor = new Color(50, 50, 50);
            }
            else if (acmPlayer.plagueTalent_10 == "N")
            {
                button10_Left.BackgroundColor = new Color(75, 75, 75);
                button10_Right.BackgroundColor = new Color(75, 75, 75);
            }
            ...
            if(acmPlayer.plagueTalent_10 != "N")
            {
                ...
                leftSinkText.SetText($"+{(acmPlayer.talentSinkPlagueLeftValue * 100).ToString("F2")}% Ability Power ({(acmPlayer.talentSinkPlagueLeftValue * acmPlayer.talentSinkPlagueLeft * 100).ToString("F2")}%)");
                rightSinkText.SetText($"+{(acmPlayer.talentSinkPlagueRightValue * 100).ToString("F2")}% Minion Crit Chance ({(acmPlayer.talentSinkPlagueRightValue * acmPlayer.talentSinkPlagueRight * 100).ToString("F2")}%)");
            } 
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if(acmPlayer.plagueTalent_1 == "N" && acmPlayer.plagueSkillPoints > 0)
            {
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                acmPlayer.plagueTalent_1 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.plagueTalent_2 == "N" && acmPlayer.plagueSkillPoints > 0 && acmPlayer.plagueSpentSkillPoints >= 1)
            {
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                acmPlayer.plagueTalent_2 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.plagueTalent_3 == "N" && acmPlayer.plagueSkillPoints > 0 && acmPlayer.plagueSpentSkillPoints >= 2)
            {
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                acmPlayer.plagueTalent_3 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.plagueTalent_4 == "N" && acmPlayer.plagueSkillPoints > 0 && acmPlayer.plagueSpentSkillPoints >= 3)
            {
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                acmPlayer.plagueTalent_4 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.plagueTalent_5 == "N" && acmPlayer.plagueSkillPoints > 0 && acmPlayer.plagueSpentSkillPoints >= 4)
            {
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                acmPlayer.plagueTalent_5 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.plagueTalent_6 == "N" && acmPlayer.plagueSkillPoints > 0 && acmPlayer.plagueSpentSkillPoints >= 5)
            {
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                acmPlayer.plagueTalent_6 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.plagueTalent_7 == "N" && acmPlayer.plagueSkillPoints > 0 && acmPlayer.plagueSpentSkillPoints >= 6)
            {
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                acmPlayer.plagueTalent_7 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.plagueTalent_8 == "N" && acmPlayer.plagueSkillPoints > 0 && acmPlayer.plagueSpentSkillPoints >= 7)
            {
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                acmPlayer.plagueTalent_8 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.plagueTalent_9 == "N" && acmPlayer.plagueSkillPoints > 0 && acmPlayer.plagueSpentSkillPoints >= 8)
            {
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                acmPlayer.plagueTalent_9 = "L";
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.plagueTalent_10 == "N" && acmPlayer.plagueSkillPoints > 0 && acmPlayer.plagueSpentSkillPoints >= 9)
            {
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                acmPlayer.plagueTalent_10 = "L";
            }
        ...
        private void LeftSink_LClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.plagueSkillPoints > 0)
            {
                acmPlayer.talentSinkPlagueLeft++;
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
        ...
        private void LeftSink_RClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if(acmPlayer.talentSinkPlagueLeft > 0)
            {
                acmPlayer.talentSinkPlagueLeft--;
                acmPlayer.plagueSkillPoints++;
                acmPlayer.plagueSpentSkillPoints--;
        ...
        private void RightSink_LClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if(acmPlayer.plagueSkillPoints > 0)
            {
                acmPlayer.talentSinkPlagueRight++;
                acmPlayer.plagueSkillPoints--;
                acmPlayer.plagueSpentSkillPoints++;
                SoundEngine.PlaySound(SoundID.MenuOpen);
            }
        ...
        private void RightSink_RClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.talentSinkPlagueRight > 0)
            {
                acmPlayer.talentSinkPlagueRight--;
                acmPlayer.plagueSkillPoints++;
                acmPlayer.plagueSpentSkillPoints--;
        ...
        {
            GetInstance<ACM2ModSystem>()._PlagueTalents.SetState(null);
            SoundEngine.PlaySound(SoundID.MenuClose);
        }
    }
}