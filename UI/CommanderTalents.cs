...
namespace ApacchiisClassesMod2.UI
{
    class CommanderTalents : UIState
    {
        ...
        string R1 = "+4% Whip Range";

        float L2Scale = 1f;
        float R2Scale = 1f;
        string L2 = "+28% Banner Range";
        string R2 = "-15% Cooldown Reduction";

        float L3Scale = .85f;
        float R3Scale = 1f;
        string L3 = "+0.2% Passive Endurance p/Slot";
        ...
        string R8 = "+8% Whip Range";

        float L9Scale = 1f;
        float R9Scale = .85f;
        string L9 = "-10% Ult Cost";
        string R9 = "+0.2% Passive Endurance p/Slot";

        float L10Scale = 1f;
        float R10Scale = 1f;
        string L10 = "+5% Whip Range";
        string R10 = "+15% Banner Endurance";
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (acmPlayer.commanderSpentSkillPoints < 1 && acmPlayer.commanderTalent_2 == "N")
            {
            ...
            if (acmPlayer.commanderSpentSkillPoints < 2 && acmPlayer.commanderTalent_3 == "N")
            {
            ...
            if (acmPlayer.commanderSpentSkillPoints < 3 && acmPlayer.commanderTalent_4 == "N")
            {
            ...
            if (acmPlayer.commanderSpentSkillPoints < 4 && acmPlayer.commanderTalent_5 == "N")
            {
            ...
            if (acmPlayer.commanderSpentSkillPoints < 5 && acmPlayer.commanderTalent_6 == "N")
            {
            ...
            if (acmPlayer.commanderSpentSkillPoints < 6 && acmPlayer.commanderTalent_7  == "N")
            {
            ...
            if (acmPlayer.commanderSpentSkillPoints < 7 && acmPlayer.commanderTalent_8 == "N")
            {
            ...
            if (acmPlayer.commanderSpentSkillPoints < 8 && acmPlayer.commanderTalent_9 == "N")
            {
            ...
            if (acmPlayer.commanderSpentSkillPoints < 9 && acmPlayer.commanderTalent_10 == "N")
            {
            ...
            if (acmPlayer.commanderTalent_10 != "N")
            {
                ...
                leftSinkText.SetText($"+{(acmPlayer.talentSinkCommanderLeftValue * 100).ToString("F2")}% Cooldown Reduction ({(acmPlayer.talentSinkCommanderLeftValue * acmPlayer.talentSinkCommanderLeft * 100).ToString("F2")}%)");
                rightSinkText.SetText($"-{(acmPlayer.talentSinkCommanderRightValue * 100).ToString("F2")}% Ultimate Cost ({(acmPlayer.talentSinkCommanderRightValue * acmPlayer.talentSinkCommanderRight * 100).ToString("F2")}%)");
            }
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if(acmPlayer.commanderTalent_1 == "N" && acmPlayer.commanderSkillPoints > 0)
            {
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.commanderTalent_2 == "N" && acmPlayer.commanderSkillPoints > 0 && acmPlayer.commanderSpentSkillPoints >= 1)
            {
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.commanderTalent_3 == "N" && acmPlayer.commanderSkillPoints > 0 && acmPlayer.commanderSpentSkillPoints >= 2)
            {
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.commanderTalent_4 == "N" && acmPlayer.commanderSkillPoints > 0 && acmPlayer.commanderSpentSkillPoints >= 3)
            {
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.commanderTalent_5 == "N" && acmPlayer.commanderSkillPoints > 0 && acmPlayer.commanderSpentSkillPoints >= 4)
            {
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.commanderTalent_6 == "N" && acmPlayer.commanderSkillPoints > 0 && acmPlayer.commanderSpentSkillPoints >= 5)
            {
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.commanderTalent_7 == "N" && acmPlayer.commanderSkillPoints > 0 && acmPlayer.commanderSpentSkillPoints >= 6)
            {
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.commanderTalent_8 == "N" && acmPlayer.commanderSkillPoints > 0 && acmPlayer.commanderSpentSkillPoints >= 7)
            {
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.commanderTalent_9 == "N" && acmPlayer.commanderSkillPoints > 0 && acmPlayer.commanderSpentSkillPoints >= 8)
            {
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
        ...
        {
            var acmPlayer = Player.GetModPlayer<ACMPlayer>();
            if (acmPlayer.commanderTalent_10 == "N" && acmPlayer.commanderSkillPoints > 0 && acmPlayer.commanderSpentSkillPoints >= 9)
            {
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
        ...
        private void LeftSink_LClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.commanderSkillPoints > 0)
            {
                acmPlayer.talentSinkCommanderLeft++;
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
        ...
        private void LeftSink_RClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.talentSinkCommanderLeft > 0)
            {
                acmPlayer.talentSinkCommanderLeft--;
                acmPlayer.commanderSkillPoints++;
                acmPlayer.commanderSpentSkillPoints--;
        ...
        private void RightSink_LClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.commanderSkillPoints > 0)
            {
                acmPlayer.talentSinkCommanderRight++;
                acmPlayer.commanderSkillPoints--;
                acmPlayer.commanderSpentSkillPoints++;
                SoundEngine.PlaySound(SoundID.MenuOpen);
            }
        ...
        private void RightSink_RClick(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            if (acmPlayer.talentSinkCommanderRight > 0)
            {
                acmPlayer.talentSinkCommanderRight--;
                acmPlayer.commanderSkillPoints++;
                acmPlayer.commanderSpentSkillPoints--;
