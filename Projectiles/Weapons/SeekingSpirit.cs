...
namespace ApacchiisClassesMod2.Projectiles.Weapons
{
    public class SeekingSpirit : ModProjectile
    {
        ...
        {
            var dust = Dust.NewDustPerfect(Projectile.Center, DustID.WhiteTorch, new Vector2(Projectile.velocity.X * .6f, Projectile.velocity.Y * .6f), 100, Color.Teal, 1.25f);
            dust.noGravity = true;
            var dust2 = Dust.NewDustPerfect(Projectile.Center, DustID.UnusedWhiteBluePurple, new Vector2(Projectile.velocity.X * .6f, Projectile.velocity.Y * .6f), 100, Color.White, 1.5f);
