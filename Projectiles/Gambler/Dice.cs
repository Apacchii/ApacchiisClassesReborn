...
namespace ApacchiisClassesMod2.Projectiles.Gambler
{
    public class Dice : ModProjectile
    {
        int timeToCollide = 45;
        int timeToHome = 6;
        bool flag = false;

        public override void SetStaticDefaults() {
            // DisplayName.SetDefault("Gambler's Die");
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft <= 60 * 3 - timeToCollide)
            ...
            //{
            //    var dust = Dust.NewDustDirect(Projectile.position, 14, 14, 180, Projectile.velocity.X * .65f, Projectile.velocity.Y * .65f, 180, Color.LightGoldenrodYellow);
            //    dust.noGravity = true;
            //}
