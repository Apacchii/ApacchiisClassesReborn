...
namespace ApacchiisClassesMod2.Items
{
	public class ClassBook : ModItem
	{
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            {
                modPlayer.globalClassLevel.Sort();
                lineKills = new TooltipLine(Mod, "Kills", string.Join("\n", modPlayer.globalClassLevel));
                level = new TooltipLine(Mod, "Level", "Level  [" + modPlayer.globalClassLevel.Count + "/" + Configs._ACMConfigServer.Instance.maxClassLevel + "]");
            }
