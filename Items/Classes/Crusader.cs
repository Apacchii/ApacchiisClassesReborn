...
namespace ApacchiisClassesMod2.Items.Classes
{
	public class Crusader : ModItem
	{
        ...
        public override void UpdateAccessory (Player Player, bool hideVisual)
		{
            ...
            acmPlayer.A2_Effect_1 = $"Damage: {(int)((acmPlayer.crusaderHammerDamageBase + acmPlayer.crusaderHammerDamageLevel * currentClassLevel) * acmPlayer.abilityPower)} = {acmPlayer.crusaderHammerDamageBase} + {acmPlayer.crusaderHammerDamageLevel} p/Level({acmPlayer.crusaderHammerDamageLevel * currentClassLevel})";
            ...
            acmPlayer.Ult_Effect_1 = $"Damage Reduction: {(decimal)((acmPlayer.crusaderGuardianAngelEndurance + acmPlayer.crusaderGuardianAngelEnduranceLevel * currentClassLevel) * 100)}% = {acmPlayer.crusaderGuardianAngelEndurance * 100}% + {acmPlayer.crusaderGuardianAngelEnduranceLevel * 100}% p/Level({(decimal)(acmPlayer.crusaderGuardianAngelEnduranceLevel * currentClassLevel * 100)}%)";
