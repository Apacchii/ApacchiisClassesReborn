...
{
	public class ManaInhibitor : ModItem
	{
        public string desc = "Grants 12% reduced mana costs while under the effects of 'Mana Sickness'\n" +
                             "Increases max mana by 5%";

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault($"[Relic] Mana Inhibitor");
