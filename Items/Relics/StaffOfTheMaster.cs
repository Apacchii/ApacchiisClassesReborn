...
{
	public class StaffOfTheMaster : ModItem
	{        public string desc = "Reduces mana costs by 15%\nIncreases magic attack speed by 12%\nIncreases magic damage by 4%\n[c/aa17f:'It would be embarassing when we met again...']";
        ...
        public override void UpdateVanity(Player player)
        {
            ...
            player.manaCost -= .15f;
            player.GetAttackSpeed(DamageClass.Magic) += .12f;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<StaffOfTheApprentice>());
            recipe.AddIngredient(ItemID.Moonglow, 80);
