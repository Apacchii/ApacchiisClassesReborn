...
{
	public class DerelictCactusRing : ModItem
	{
        public string desc = "Increases healing power by 13%\n" +
                             "Increases max health by 2.5%";

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault($"[Relic] Derelict Cactus Ring");
        ...
        public override void UpdateVanity(Player player)
        {
            ...
            acmPlayer.hasCactusRing = true;
            acmPlayer.healingPower += .14f;
            acmPlayer.lifeMult += .025f;
