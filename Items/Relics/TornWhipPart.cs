...
{
	public class TornWhipPart : ModItem
	{
        public string desc = "Increases whip range by 7%\n" +
                             "Increases whip damage by 2%\n" +
                             "Increases minion crit chance by 1%";

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault($"[Relic] Torn Whip Part");
        ...
        public override void UpdateVanity(Player player)
        {
            ...
            player.whipRangeMultiplier += .07f;
            acmPlayer.minionCritChance += .01f;
            player.GetDamage(DamageClass.SummonMeleeSpeed) += .02f;
