...
{
	public class MinionsRightsContract : ModItem
	{
        public string desc = "Increases minion slots by 1\n" +
                             "Reduces whip damage by 18%\n" +
                             "[c/e796e8:> Donator Item <]\n[c/e796e8:[Thank you for your support, CaineSenpai!][c/e796e8:]]";

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault($"[Relic] Minion's Rights Contract");
        ...
        public override void UpdateVanity(Player player)
        {
            ...
            player.GetDamage(DamageClass.SummonMeleeSpeed) -= .18f;
            player.maxMinions += 1;
