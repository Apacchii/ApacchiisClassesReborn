...
{
	public class PocketSlime : ModItem
	{
        public string desc = "Grants you immunity to knockback\n" +
                             "Reduces max health by 5%";

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault($"[Relic] Pocket Slime");
