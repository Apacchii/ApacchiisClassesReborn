...
namespace ApacchiisClassesMod2.Items.Relics
{
	...
	{
        public string desc = "Reduces potion sickness duration by 6 seconds\nPotions heal for an additional 7.5% of your max health";

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault($"[Relic] Broken Heart");
        ...
        public override void UpdateVanity(Player player)
        {
            ...
            acmPlayer.hasBrokenHeart = true;
            player.potionDelayTime -= 360;
